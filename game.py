...
class Game:
    ...
    def __init__(self, caption="Crusader Empire"):
        ...
        self.font = pygame.font.Font(os.path.join('data/assets/title_font.ttf'), 20)
        self.running = False
    ...
    def run(self):
        ...
        while self.running:
            ...
            hud = self.font.render(f"wood: {self.wood}   iron: {self.iron}   food: {self.food}/{self.max_food}",
                                   True, (0, 0, 0))
